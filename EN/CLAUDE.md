...
You are working inside an `obsidian_llm_wiki_plus` Vault. This file is for Claude Code.
...
3. Before batch creation, batch modification, moving, archiving, or restructuring directories, propose a plan and wait for user confirmation.
