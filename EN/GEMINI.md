...
You are working inside an `obsidian_llm_wiki_plus` Vault. This file is for Gemini CLI / Gemini Agent.
...
1. For complex tasks, read `.agents/index.md` first.
2. Then read the corresponding `.agents/skills/<skill>/SKILL.md`.
3. Before running commands, batch creation, batch modification, moving, archiving, or restructuring directories, propose a plan and wait for user confirmation.
4. Do not duplicate full workflow logic in this file. This file is an entry point.
